...
def XForce_Reputation_domain(domain):
    """
        ...
        key: be7dbcf1-70f4-4960-b00a-71c9fc985f41
        pw: e231c5ce-2c19-4cd7-a04b-628287da3629
    """

    key = 'be7dbcf1-70f4-4960-b00a-71c9fc985f41'
    password = 'e231c5ce-2c19-4cd7-a04b-628287da3629'
...
def main():
    ...
    # with open('VT_final_result.csv', 'r') as vt:
    #     vt_content = csv.reader(vt)

    #     for element in vt_content:
    #         sing_elem = element[1].split(']')
    #         ret_vect_vt.append(sing_elem[0])

    # with open('XForce_final_result.csv', 'r') as xf:
    #     xf_content = csv.reader(xf)

    #     for element in xf_content:
    #         sing_elem = element[1].split(']')
    #         ret_vect_xf.append(sing_elem[0])


    # with open('PageRank_final_results.csv', 'r') as pr:
    #     pr_content = csv.reader(pr)

    #     for element in pr_content:
    #         sing_elem = element[1].split(']')
    #         ret_vect_pr.append(sing_elem[0])
                
    # final_vect = []

    # for i in range(0, len(ret_vect_vt)):

    #     final_vect.append(ret_vect_vt[i])
    #     final_vect.append(ret_vect_xf[i])
    #     final_vect.append(ret_vect_pr[i])

    #     with open('web_based_feature.csv', 'a') as wcsv:
    #         csv_write = csv.writer(wcsv)
    #         csv_write.writerow(final_vect)
